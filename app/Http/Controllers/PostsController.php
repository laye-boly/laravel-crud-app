...
class PostsController extends Controller
{
     ...
     * Permet de bloquer l'accès aux pages rendues par ce controlleur sauf exceptés celle précisées
     * @return void
     */
    public function __construct()
    {
        // On exige la connection du user sauf pour les vues home et show
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('cover_image')){
            ...
            // ON le fait avec la commande php artisan storage:link
            $path = $request->file('cover_image')->storeAs('public/cover_images', $fileNameToStore);
            // On récupère l'ancien image
            $oldImage = $post->cover_image;
            // On lie la nouvelle image à post
            $post->cover_image = $fileNameToStore;
            // Puisqu'une nouvelle image est associé à notre post, on supprime l'ancien image de notre dossier d'images
    ...
    public function destroy($id)
    {
        ...
        // On supprime l'image des que le poste est supprimé
